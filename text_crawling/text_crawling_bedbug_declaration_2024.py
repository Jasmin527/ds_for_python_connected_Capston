...
try:
    ...
    # "빈대 신고" 키워드로 크롤링
    keyword = "%EB%B9%88%EB%8C%80+%EC%8B%A0%EA%B3%A0"  # "빈대 신고"의 URL 인코딩 값
    ...
    for month in range(start_month, end_month + 1):
        for day in days_range[month]:
            ...
            while True:
                ...
                for i in name_list:
                    date_str = f"2024.{formatted_month}.{formatted_day}"
                ...
                print(f"2024.{formatted_month}.{formatted_day}에서 기사를 모두 수집했습니다.")
                break
